...
from published_events_deploy.apps.events.views import CategoriesView, CreateEventView, EventView, ListEvents, DetailEvent, NearEvents
...
router.register(viewset=CreateEventView, basename="event", prefix="events/create")
